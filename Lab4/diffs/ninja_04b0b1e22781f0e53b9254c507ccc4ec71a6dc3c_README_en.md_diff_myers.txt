...
index 19f5f3e..d759e41 100644
--- a/README_en.md
+++ b/README_en.md
@@ -29,9 +29,9 @@ Not just an unofficial ChatGPT proxy (bypass Cloudflare 403 Access Denied)
...
+dpkg -i opengpt-0.1.3-x86_64-unknown-linux-musl.deb
 ...
 opengpt serve
 ```
@@ -52,11 +52,11 @@ docker run --rm -it -p 7999:7999 --hostname=opengpt \
