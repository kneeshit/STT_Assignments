...
index 8db1a8d..a8a5d08 100644
--- a/README.md
+++ b/README.md
@@ -50,8 +50,8 @@ A reverse engineered unofficial `ChatGPT` proxy (bypass Cloudflare 403 Access De
...
+opkg install opengpt_0.3.6_aarch64_generic.ipk
 ...
 ```
@@ -177,28 +177,52 @@ Start the http server
